...
formGroup!:FormGroup;
  constructor(private readonly fb:FormBuilder,private readonly courseService:CourseService, public dialogRef: MatDialogRef<CourseFormDialogComponent>,
  ...
  initForm():void{
   this.formGroup =  this.fb.group({
     id:[this.courseToUpdate?.id  || new Date().getTime(),[Validators.required]],
  ...
  submitForm(){
    ...
    this.courseService.updateCourse(this.formGroup.value,this.courseToUpdate.id).subscribe(()=>this.dialogRef.close())
  }
}
